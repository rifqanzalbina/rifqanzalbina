...
[![My Skills](https://skillicons.dev/icons?i=react,next,tailwind,ts,js,html,css,php,python,java,cs,mysql,scss,bootstrap,git,jquery,nodejs,express,git,github,django,vercel,bootstrap,discord,figma,vscode&perline=9)](https://skillicons.dev)
